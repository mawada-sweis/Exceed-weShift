...
exports.add_by_customer = async (req, res) => {
...
exports.show_by_customer = async (req, res) => {

    let requests = "SELECT * FROM `Request` WHERE Customer_ID_FK = ?";
    con.query(requests, [req.params.id],
        (err, respon) => {
            if (err) throw err;
...
exports.delete_by_customer = async (req, res) => {
...
exports.updated_by_customer = async (req, res) => {
